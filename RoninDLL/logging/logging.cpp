...
namespace NS::log
{
	...
	std::shared_ptr<ColoredLogger> RONIN;
...
void CreateLogFiles()
{
	...
	else
	{
		...
		catch (...)
		{
			...
			MessageBoxA(
				0, "Failed creating log file! Make sure the profile directory is writable.", "Ronin Warning", MB_ICONWARNING | MB_OK);
		}
	}
}
...
void InitialiseLogging()
{
	...
	NS::log::FZZY = std::make_shared<ColoredLogger>("FZZY", NS::Colors::FZZY);
