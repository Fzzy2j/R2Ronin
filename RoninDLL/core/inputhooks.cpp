...
bool SRMM_GetSetting(int pos)
{
	...
	uintptr_t srmmSettingBase = (uintptr_t)GetModuleHandle(L"engine.dll") + 0x8A159C;
...
AUTOHOOK(PostEvent, inputsystem.dll + 0x7EC0,
	unsigned int, __fastcall, (uintptr_t a, InputEventType_t nType, int nTick, ButtonCode_t scanCode, ButtonCode_t virtualCode, int data3))
{
