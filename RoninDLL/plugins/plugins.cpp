...
std::optional<Plugin> PluginManager::LoadPlugin(fs::path path, PluginInitFuncs* funcs, PluginRoninData* data)
{
...
bool PluginManager::LoadPlugins()
{
	...
	pluginPath = GetRoninPrefix() + "/plugins";

	PluginRoninData data {};
	...
	data.roninModule = g_RoninModule;
