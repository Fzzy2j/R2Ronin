...
void ServerPresenceManager::CreateConVars()
{
	...
	Cvar_ns_server_name = new ConVar("ns_server_name", "Unnamed Ronin Server", FCVAR_GAMEDLL, "This server's description", false, 0, false, 0, [](ConVar* cvar, const char* pOldValue, float flOldValue) {
